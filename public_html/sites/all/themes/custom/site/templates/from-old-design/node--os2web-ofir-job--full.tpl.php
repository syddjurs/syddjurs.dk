<article<?php print $attributes; ?>>
  ...
  <div class="clearfix">
    ...
    <?php endif; ?>
    <?php if (!$teaser && arg(0) == 'node' && is_numeric(arg(1))): $nodeid = arg(1); ?>
    ...
    <div class="del-bund">
      <div class="del">
        <div class="addthis_toolbox addthis_default_style addthis_32x32_style">
          <a class="addthis_button_compact">Del <img alt="blank" src="/<?php print $theme_path = drupal_get_path('theme', variable_get('theme_default', NULL)); ?>/dist/img/blank.png"/> </a>
        </div>
      </div>
  ...
  <?php endif; ?>
  <?php if (!$teaser): ?>
    <div class="last-updated-node">
      Oprettet: <?php print format_date($node->created, "short"); ?><br />
      Opdateret: <?php print format_date($node->changed, "short"); ?>
    </div>
  <?php endif; ?>
</article>
