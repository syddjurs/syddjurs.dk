...
Description
-----------
This module provides basic accessible megamenus.
...
Configuration
-----------
After enabling this module, create menu links with associated mini panels at
admin/config/os2web_menus/items. You can alter a few settings at admin/config/os2web_menus/settings.

To show these menus, add the block OS2web menus to your chosen region.
